...
public class ImagePreference4 extends Preference {
	private Drawable mIcon;
	Bitmap a;
	boolean button = false;
	private int mClickCounter;

	public ImagePreference4(final Context context, final AttributeSet attrs,
			final int defStyle) {
		super(context, attrs, defStyle);

		this.setLayoutResource(R.layout.imagepref4);
